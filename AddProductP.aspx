<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.Master" AutoEventWireup="true" CodeBehind="AddProductP.aspx.cs" Inherits="WebFastfood.AddProductP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="AddProductForm" runat="server" method="POST">
        <div style="width: 80%; margin-left: auto; margin-right: auto;">
            ...
            <div class="form-row">
                <div class="form-group col-md-7">
                    <div class="form-group">
                        ...
                        <asp:RangeValidator ID="PriceValidator"
                            ...
                            runat="server"
                            ValidationGroup="AddProductFormValidate">
                        </asp:RangeValidator>
                ...
                <div class="form-group col-md-5">
                    <div class="form-group">
                        ...
                        <asp:FileUpload ID="PictureUpload" runat="server" AllowMultiple="false" CssClass="form-control upload_img" accept="image/png, image/jpeg" required="required" BorderStyle="None" />
                    </div>
                    <div class="form-group">
                        <br />
                        <asp:Image runat="server" ID="product_img" class="rounded mx-auto d-block img_shadow product_img img_d_n1" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group d-flex flex-wrap  col-md-12 justify-content-center">
                    <asp:Button ID="AddButton" Text="Add" OnClick="AddButton_Click" runat="server" CssClass="btn btn-success col-md-2" ValidationGroup="AddProductFormValidate" Style="padding-left: 30px; padding-right: 30px;" />
                </div>
            </div>
